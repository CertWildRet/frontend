...
export function OreBoardHero({
  ...
  return (
    <PoolIntro
      ...
      tilesLabel="25 tiles"
      blurb="On rounds it mines, the miner covers the whole 25-tile board; claim when the window opens, or hold your dORE and let it keep compounding into stORE. Disciplined: it only commits on rounds it likes."
      bullets={[
